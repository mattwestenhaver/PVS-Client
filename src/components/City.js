  ...
  render() {
    return(
      <div className='city-container'>
        <Helmet>
          <meta charSet="utf-8" />
          <title>{this.props.city} - Premiere Valet Service, Inc.</title>
        </Helmet>
        <div className='city-section-1'>
          <h1>{this.props.city} Valet Services</h1>
          <p>There are many {this.props.city} Valet Companies, but Premiere Valet Service, Inc. is proudly the number one in {this.props.city}. If you are hosting an event in {this.props.city} and need valet, Premiere Valet Service, Inc. can offer you first class valet services and a level of service that no other valet company in the area can.</p>
          <p>With over 25 years in the valet business, Premiere Valet Service, Inc. is the number one valet service in all of Southern California. We are the first choice valet company for all private events; from pre-Oscar private parties to small home gatherings. Parking in {this.props.city} can be difficult, but with Premiere Valet Services you and your guests can enjoy your next private event with peace of mind.</p>
