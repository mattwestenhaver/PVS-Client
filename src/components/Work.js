            ...
            <div>
                ...
                <div className="work-section-1">
                    <div className="work-information">
                        ...
                        <p>
                            All positions are part-time valet attendant roles, and it is required that you are available
                            to work nights and weekends. The job can be physically demanding, and most of the time we
                            are expected to work at night. We work in the cold, heat, rain, etc. Many jobs are located
                            in the hills and you will be expected to run to and from the cars you are parking. There
                            also may be extended periods of standing during a shift.
                        </p>
                            ...
                            <Form onSubmit={this.workSubmit.bind(this)}>
                                ...
                                <Form.Field>
                                    ...
                                    <input
                                        type="text"
                                        ref="reference"
                                        placeholder="Put employee's name if an employee referred you"
                                    />
                                </Form.Field>
                                ...
                                <Form.Field>
                                    ...
                                    <input
                                        type="text"
                                        ref="skills"
                                        placeholder="List any skills you think we should know about"
                                    />
                                </Form.Field>
                                ...
                                <Form.Field>
                                    ...
                                    <textarea
                                        ref="about"
                                        rows="4"
                                        placeholder="Put anything you think we should know"
                                    />
                                </Form.Field>

                                <Form.Field>
                                    <Form.Select
                                        label="What location are you applying for?"
                                        name="location"
                                        value={location}
